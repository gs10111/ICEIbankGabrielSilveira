...
class ContaControllerTest {
    ...
    private MockMvc mvc() {
        return MockMvcBuilders.webAppContextSetup(contexto).addFilters(
                contexto.getBean(br.pucminas.iceibank.infra.seguranca.ConfiguracaoDeSeguranca.class)
                        .filtroJwt(jwtService, contexto.getBean(
                                br.pucminas.iceibank.infra.seguranca.SegurancaProperties.class)).getFilter()).build();
    }
